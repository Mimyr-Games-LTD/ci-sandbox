...
const CFG_PATH : String = "res://addons/sync_spreadsheets/sync_csv_spreadsheets.cfg"
const RESOURCE_PATH: String = "res://addons/sync_spreadsheets/sync_csv_spreadsheets.tres"
...
func _sync_csv_files():
	...
	for csv_path in csv_paths:
		...
		if not exist:
			var new_sheet_resource : Resource = SheetResource.new(csv_path, "", "", "", true)
...
func _load_config():
	...
	if ResourceLoader.exists(RESOURCE_PATH):
		var new_sheets_resource = ResourceLoader.load(RESOURCE_PATH)
...
func _save_config():
	ResourceSaver.save(sheets_resource, RESOURCE_PATH)
...
func _sync_sheet_callback(r, err, sheet : SheetResource):
	_save_config()
...
func _on_open_sheets_resource_pressed():
	...
	EditorInterface.get_inspector().resource_selected.emit(sheets_resource, RESOURCE_PATH)
